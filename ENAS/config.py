...
misc_arg.add_argument('--train_size', type=int, default=1000, help='size of the training set')
misc_arg.add_argument('--eval_size', type=int, default=1000, help='size of the validation set')
misc_arg.add_argument('--test_size', type=int, default=1000, help='size of the test set')
